...
with open(file_3, 'w', newline="") as csv_f:
    ...
    for i in range(1, 101):
        ...
        random_number_of_days = random.randrange(days_between_dates)
        random_date = start_date + datetime.timedelta(days=random_number_of_days)
        row = {"Number": count, "Name": name_3, "Email": name_true_3 + '@gmail.com',"Date":str(random_date)}
        writer.writerow(row)
        count += 1

    for i in range(1, 151):
        name_4 = names.get_full_name(None)
        name_true_4 = name_4.replace(" ", "")
        ...
        random_number_of_days = random.randrange(days_between_dates)
        random_date = start_date + datetime.timedelta(days=random_number_of_days)
        row = {"Number": count, "Name": name_4, "Email": name_true_4 + '@gmail.com',"Date":str(random_date)}
        writer.writerow(row)
        count += 1

    for i in range(1, 151):
        name_5 = names.get_full_name(None)
        name_true_5 = name_5.replace(" ", "")
        ...
        random_number_of_days = random.randrange(days_between_dates)
        random_date = start_date + datetime.timedelta(days=random_number_of_days)
        row = {"Number": count, "Name": name_5, "Email": name_true_5 + '@gmail.com',"Date":str(random_date)}
        writer.writerow(row)
        count += 1
